...
local planetary_teleporter_animation = {
  layers = {
    --SHADOW
    {
      filename = "__Spaghetorio__/graphics/krastorio/entities/planetary-teleporter/hr-planetary-teleporter-shadow.png",
      priority = "low",
      width = 531,
      height = 292,
      scale = 0.5,
    ...
    --BUILDING
    {
      filename = "__Spaghetorio__/graphics/krastorio/entities/planetary-teleporter/new/hr-teleporter-base-combined.png",
      priority = "medium",
      width = 400,
      height = 475,
      scale = 0.5,
    ...
    {
      filename = "__Spaghetorio__/graphics/krastorio/entities/planetary-teleporter/new/hr-teleporter-under-forward-towers.png",
      priority = "medium",
      width = 400,
      height = 475,
      scale = 0.5,
    ...
    -- GLOWS
    {
      filename = "__Spaghetorio__/graphics/krastorio/entities/planetary-teleporter/new/hr-teleporter-base-combined-glow.png",
      priority = "high",
      width = 400,
      height = 475,
      scale = 0.5,
    ...
    {
      filename = "__Spaghetorio__/graphics/krastorio/entities/planetary-teleporter/new/hr-teleporter-forward-towers-light.png",
      priority = "extra-high",
      width = 400,
      height = 475,
      scale = 0.5,
...
local planetary_teleporter_animation_red = {
  layers = {
    ...
    -- TINT
    {
      filename = "__Spaghetorio__/graphics/krastorio/entities/planetary-teleporter/new/hr-teleporter-base-combined-glow-red.png",
      flags = { "mask" },
      priority = "extra-high",
      width = 400,
      height = 475,
...
data:extend({
  {
    ...
    working_sound = {
      sound = {
        filename = "__Spaghetorio__/sounds/buildings/planetary-teleporter-working-sound.ogg",
        volume = 0.50,
      },
      idle_sound = { filename = "__base__/sound/idle1.ogg" },
      apparent_volume = 0.75,
    },
    open_sound = { filename = "__Spaghetorio__/sounds/buildings/planetary-teleporter-open-sound.ogg", volume = 1 },
    close_sound = { filename = "__Spaghetorio__/sounds/buildings/planetary-teleporter-close-sound.ogg", volume = 0.8 },
...
data:extend({
  ...
  -- overlay
  {
    ...
    picture = {
      layers = {
        {
          filename = "__Spaghetorio__/graphics/krastorio/entities/planetary-teleporter/new/hr-teleporter-forward-towers.png",
          width = 400,
          height = 475,
          scale = 0.5,
        },
